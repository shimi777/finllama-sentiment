# Deck dump: implementation_deck.pptx
...
- Inference only — no fine-tuning, no multimodal, no trading simulation
...
- Best F1-macro per model × dataset. [NUM] placeholders are filled from the live results table.

**[Table — Slide 14]**

| Model | FPB · F1-macro | FPB · Accuracy | FiQA · F1-macro | FiQA · Accuracy |
|---|---|---|---|---|
| plutus-8B-instruct (focal) | [NUM] | [NUM] | [NUM] | [NUM] |
| Mistral-7B-Instruct-v0.3 | [NUM] | [NUM] | [NUM] | [NUM] |
| Qwen2.5-7B-Instruct | [NUM] | [NUM] | [NUM] | [NUM] |
| FinBERT (specialised classifier) | [NUM] | [NUM] | [NUM] | [NUM] |
| VADER (lexicon) | [NUM] | [NUM] | [NUM] | [NUM] |
- Pull live numbers from results/summary/final_table.csv (visible in the dashboard at :8502).
...
- Bottom line
- [Insert a one-sentence answer to the research question once the matrix completes — e.g. 'Financial instruction tuning gave plutus-8B a [NUM]-point F1 edge over the strongest general 7B LLM on FPB, but the small specialised FinBERT still outperformed every 8B model on this in-domain task.']
- Two takeaways for the audience to remember:
- 1. [primary takeaway — fill in once you have the numbers]
